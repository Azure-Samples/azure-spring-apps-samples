...
This application can co-work with football-billboard long-running application. Please reference [Quickstart](https://aka.ms/first-spring-batch-job) to learn more.
